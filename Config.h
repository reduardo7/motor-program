...
// Countdown before start (120 sec)
// {Seconds}
const unsigned long DELAYED_START_TIME = 120UL;
...
// Manual start working duration (15 min)
// {Seconds}
const unsigned long WORKING_DURATION_TIME = 15UL * 60UL;
